  ...
  <div className={styles.qualification__tabs}>
    {qualification_tabs.map((item) => (
      <div
        ...
        key={item.id}
        className={`${styles.qualification__button} ${
          selectedTabs === item.id ? "" : styles.qualification__active
        } button--flex`}
      >
...
const renderQualificationList = ({ qualificationList }) => (
  <div
    className={`${styles.qualification__content} ${styles.qualification__content__active}`}
  >
...
const useQualificationHooks = () => {
  ...
  const [qualificationList, setQualificationList] = useState(
    findQualificationList(selectedTabs)
  );
  const domRef = useRef();
