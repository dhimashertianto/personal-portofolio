...
const {
  about_content: { title, subtitle, description, button_cv },
} = constants;
    ...
    >
      ...
      <div className={`${styles.about__container} container grid`}>
        ...
        <div className={styles.about__data}>
          ...
          <a
            href="https://drive.google.com/file/d/1xOtu7wtNTCR8Lq-FHhYkukEN2QDzTUgJ/view?usp=sharing"
            download="CV_DHIMAS HERTIANTO.pdf"
